  ...
  <div class="search">
    <form action="#" method="post" id="sitesearch">
      ...
      <form action="productList1.jsp?pageNo1=1&flag1=0" method="post">
        <input type="text" name="search" value="搜索一下" onFocus="if(value==defaultValue){value='';this.style.color='#000'}" onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="color:#999" />        
        <input type="image" src="assets/images/search.png" id="search" alt="搜索一下">
        <input type="hidden" name="pageNo1" value=1>
      </form>
      </fieldset>
    </form>
  </div>
...
try{
    ...
    List<Classify> all=DAOFactory.getIClassifyDAOInstance().findClassify(cno);
    List<Classify> pages=DAOFactory.getIClassifyDAOInstance().pager(cno,pageNo,pageSize);
    ...
    //===============计算结束=========================
    Iterator<Classify> iter=pages.iterator();
  %>  
<center>
 <br> <br> <br> <br> <br> <br> <br> <br> <br>
 <a href="productList1.jsp?pageNo1=1&flag1=0">全部商品</a><br/><br/>
...
<%
    ...
    while(iter.hasNext()){
    	...
    	Product product=DAOFactory.getIProductDAOInstance().findByld(classify.getPno());
%>
...
<div class="content">
  <div class="content1">
    <h4>购物指南</h4>
    <ul class="f_nav">
      <li><a href="example.html">购物流程</a></li>
      <li><a href="example.html">会员介绍</a></li>
      <li><a href="example.html">团购|机票</a></li>
      <li><a href="example.html">常见问题</a></li>
      <li><a href="example.html">意见反馈</a></li>
      <li><a href="example.html">联系客服</a></li>
    </ul>
  </div>
  <div class="content1">
    <h4>配送方式</h4>
